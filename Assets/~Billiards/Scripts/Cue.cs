...
namespace Billiards
{
    public class Cue : MonoBehaviour
    {
        ...
        public float maxDistance = 5f; // The maximum distance in units the cue be dragged back
        // [UI Challenger] Sloder element here
        ...
        void Aim()
        {
            ...
            {
                // Obtain direction from cue's position to the raycast's hit point
